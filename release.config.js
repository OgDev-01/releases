...
!GIT_COMMITTER_NAME && (process.env.GIT_COMMITTER_NAME = "ogdev-release[bot]");
!GIT_COMMITTER_EMAIL && (process.env.GIT_COMMITTER_EMAIL = "ogdev-release[bot]@users.noreply.github.com");
